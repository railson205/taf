...
class Exercicios extends CI_Controller
{
    ...
    {
        $data = [
            'nome_do_exercicio' => $this->input->post('nome_do_exercicio'),
            'modo_de_contagem' => $this->input->post('modo_de_contagem'),
        ];
    ...
    function editar_exercicio()
    {
        $id = $this->input->post('exercicio_id_editar');
        $data = [
            'nome_do_exercicio' => $this->input->post('exercicio_nome_do_exercicio_editar'),
            'modo_de_contagem' => $this->input->post('exercicio_modo_de_contagem_editar'),
        ];
        $resultado = $this->Exercicios_model->editar_exercicio($id, $data);
        $this->session->set_flashdata('alert_type', $resultado['type']);
        $this->session->set_flashdata('alert_message', $resultado['message']);
