                                    ...
                                    <tbody>
                                        <?php foreach ($exercicios as $exec): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $exec['modo_de_contagem'] == "Tempo" ? segundos_para_tempo($exec['indice']) : $exec['indice'] ?>
                                                    </td>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="d-flex gap-2 justify-content-center">
                                                                    <button class="btn btn-sm btn-primary btn-edicao" data-bs-toggle="modal"
                                                                        data-bs-target="#resultado_modal_editar" data-selecionado='<?= json_encode([
                                                                            ...
                                                                            'indice' => $exec['indice'],
                                                                             ...
                                                                             'Índice'=>$indices_id_options
                                                                         ]) ?>'
                                                                         data-filtro='<?= json_encode([
                                                                             "Índice"=>"exercicio_id"
                                                                         ]) ?>'
                                                                         >
